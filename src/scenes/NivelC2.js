class NivelC2 extends Phaser.Scene{
    ...
    create() {
        ...
        //PERSONAJES
        //Javier Samurai
        this.javier = this.physics.add.sprite(300, 500, 'Samurai', 0).setAlpha(1).setDepth(3).setScale(0.26);
        this.javier.body.setSize(300, 560);
        this.javier.body.setMass(1);
        this.javier.flipX=false;

        //Puerta
        this.puerta = this.physics.add.staticImage(1510, 690, 'NivelC2/puerta').setScale(0.3).refreshBody();;
        //this.puerta.body.setSize(430,100);
